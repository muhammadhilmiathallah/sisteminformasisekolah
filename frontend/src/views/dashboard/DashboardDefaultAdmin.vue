      ...
      <div v-else>
        ...
        <section class="charts">
          <div class="chart-container">
            ...
            <p class="chart-description">Grafik batang ini menampilkan jumlah kritik dan saran yang masuk berdasarkan kelas.</p>
            <Chart v-if="kritikSaranChartData" type="bar" :data="kritikSaranChartData" :options="kritikSaranChartOptions" />
          </div>

          <div class="chart-container">
            <h3 class="chart-title">Distribusi Siswa per Kelas</h3>
            <p class="chart-description">Grafik pie ini menggambarkan jumlah siswa yang terdistribusi di setiap kelas.</p>
            <Chart
...
export default {
  ...
  methods: {
    ...
    prepareCharts() {
      ...
      const colors = ['#003080', '#00509e', '#0077b6', '#0096c7', '#00b4d8', '#48cae4', '#90e0ef', '#ade8f4', '#caf0f8', '#d0f0ff'];

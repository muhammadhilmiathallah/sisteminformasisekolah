<template>
  ...
  <img src="@/assets/foto/Logo Sekolah.png" alt="Logo Sekolah" class="school-logo" />
      ...
      <ul>
        ...
        <li @click="showForm('user-regist')"><i class="fa fa-user-plus"></i> Data User</li>
        <li @click="showForm('input-data-siswa')"><i class="fa fa-user-edit"></i> Input Data Siswa</li>
        <li @click="showForm('master-siswa')"><i class="fa fa-users"></i> Data Siswa</li>
        <li @click="showForm('master-guru')"><i class="fa fa-chalkboard-teacher"></i> Data Guru</li>
        <li @click="showForm('data-kelas')"><i class="fa fa-door-open"></i> Kelas</li>
        ...
        <li @click="showForm('master-jadwal-pelajaran')"><i class="fa fa-calendar-alt"></i> Jadwal Pelajaran</li>
        <li @click="showForm('kirim-surat')"><i class="fa fa-envelope"></i> Kirim Surat</li>
        <li @click="showForm('tanggal-libur')"><i class="fa fa-bullhorn"></i> Informasi Sekolah</li>
...
.sidebar {
  width: 280px;
  background: linear-gradient(160deg, #0f2027, #203a43, #2c5364); /* dark navy gradient */
  color: #e0f8ea;
  padding: 30px;
  display: flex;
...
.sidebar ul li:hover {
  background-color: rgba(46, 204, 113, 0.2); /* subtle green glow */
  padding-left: 18px;
}
.sidebar ul li i {
  margin-right: 16px;
...
.navbar {
  background: linear-gradient(135deg, #3a6073, #16222a); /* elegant blue to dark gradient */
  color: white;
  padding: 20px;
  display: flex;

  ...
  <div class="card">
    ...
    <div v-if="selectedKelasId && selectedMapelId && selectedTahunPelajaranId" class="mt-4">
      <DataTable :value="nilaiList" dataKey="siswa_id" responsiveLayout="scroll">
        ...
        <Column field="nilai_ujian" header="UAS" />
...
// ✅ FLEKSIBEL: hitung rata-rata hanya dari nilai yang diisi
...
const simpanNilaiDialog = async () => {
  ...
  // ✅ Validasi minimal 1 nilai terisi
  if (siswa.nilai_tugas == null && siswa.nilai_uts == null && siswa.nilai_ujian == null) {
    toast.add({ severity: 'warn', summary: 'Tidak Ada Nilai', detail: 'Minimal satu nilai harus diisi!', life: 3000 })
    return
  }
  ...
  siswa.rata_rata = hitungRataRata(siswa.nilai_tugas, siswa.nilai_uts, siswa.nilai_ujian)
  siswa.grade = siswa.rata_rata !== null ? tentukanGrade(siswa.rata_rata) : null
  ...
  try {
    ...
    toast.add({
      severity: 'success',
      summary: 'Berhasil',
      detail: isEdit ? 'Nilai diperbarui.' : 'Nilai disimpan.',
      life: 1500
    })

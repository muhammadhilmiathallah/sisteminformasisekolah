<template>
  <div class="p-4">
    ...
    <DataTable :value="kelasList" :key="kelasList.length" :paginator="true" :rows="10" responsiveLayout="scroll" stripedRows class="mb-4">
    ...
    <Dialog v-model:visible="showDialog" :header="form.id ? 'Edit Kelas' : 'Tambah Kelas Baru'" modal :closable="true" :style="{ width: '30vw' }">
      <div class="p-fluid">
        ...
        <Dropdown v-model="form.guru_id" :options="guruList" optionLabel="nama" optionValue="id" placeholder="Pilih Guru" class="mb-3" />
    ...
    <Dialog v-model:visible="showDeleteDialog" header="Konfirmasi Hapus" modal :closable="false" :style="{ width: '350px' }">
      <div class="p-3">
        <p>

<template>
  <div class="container">
    ...
    <div class="toolbar">
      <Button label="Tambah Informasi Sekolah" icon="pi pi-plus" @click="showDialog = true" />
    </div>

    <DataTable :value="dataLibur" responsiveLayout="scroll">
      <Column field="tanggal" header="Tanggal Posting" />
      <Column field="judul" header="Judul " body-class="wrap-column" style="max-width: 200px" />
      <Column field="keterangan" header="Isi" body-class="wrap-column" style="max-width: 250px" />
      <Column header="Aksi">
    ...
    <Dialog v-model:visible="showDialog" header="Form Tanggal Libur" modal :style="{ width: '450px' }">
      ...
      <div class="form-layout">
        ...
        <div class="form-group">
          <label for="keterangan">Isi Informasi</label>
          <Textarea
            id="keterangan"
